...
export default function FinancingSection() {
    return (
        <section id="financing" className="section-padding bg-brand-dark relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16">
                    ...
                    <div className="w-full md:w-1/2">
                        <div className="inline-flex items-center space-x-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full px-4 py-1.5 mb-6">
                            ...
                            <span className="text-[10px] md:text-sm font-black uppercase tracking-widest text-gray-300">Flexible Financing</span>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-10">
                            {[
                                ...
                                { title: 'All Credit Types', desc: 'We work with lenders to find solutions for every credit profile.' },
                                { title: 'Trade-In Valuations', desc: 'Top dollar for your current vehicle to lower your payments.' }
                            ].map((item, i) => (
                                <div key={i} className="flex items-start space-x-3 group">
                                    <div className="w-6 h-6 rounded-full bg-brand-accent/20 flex items-center justify-center flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform">
                        ...
                        <Link
                            href="/financing"
                            className="btn-modern bg-white text-brand-dark hover:bg-gray-100 px-8 py-3.5 rounded-full font-bold shadow-lg shadow-white/10 transition-all hover:scale-105 active:scale-95 w-full sm:w-auto text-center block"
                        >
                            Apply for Financing
                        </Link>
                    </div>
                    ...
                    <div className="w-full md:w-1/2 relative mt-8 md:mt-0">
                        ...
                        {/* Background Glow */}
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-brand-accent/20 blur-[100px] -z-10 rounded-full animate-pulse-slow"></div>
                    </div>
                </div>
            </div>
        </section>
